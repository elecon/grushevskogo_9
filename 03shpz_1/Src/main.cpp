...
*/
NET_OUTPUT_STRUCT1 data_from_slave1;
NET_INPUT_STRUCT1 data_for_slave1;
//NET_OUTPUT_STRUCT2 data_from_slave2;
//NET_INPUT_STRUCT2 data_for_slave2;
...
//		}
//		else {
//			//if (NetPackInfo<40) NetPackInfo++;
//		}
////---------------------------------------------------------------------------------------
//		memcpy((uint8_t*)&tx_local_buffer0,
//		(uint8_t*)&data_from_slave1,
//		sizeof(NET_INPUT_STRUCT1));
//		cur_address0=data_from_slave1.head.adr;
////---------------------------------------------------------------------------------------
//		uart_status0=0;
//		uart_init0();
//		set_uart0_to_receive();
